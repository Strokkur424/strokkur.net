      ...
      head: [
        {
          ...
          content: `{"component":{"type":17,"accent_color":16741120,"components":[{"type":9,"components":[{"type":10,"content":"# 🔥 StrokkCommands by <@813141164281692170>\\nA compile-time only, annotation-based command library for Paper and Velocity! Save yourself some time writing Brigadier commands by hand, if you can generate them on the fly!"}],"accessory":{"type":11,"media":{"url":"https://commands.strokkur.net/patchnotes.png"}}},{"type":10,"content":"An example? Sure~\\n\`\`\`java\\n@Command(\\"give\\")\\nclass GiveCommand {\\n\\n  @Executes\\n  void give(\\n    CommandSender sender,\\n    ItemStack item, \\n    @DefaultToExecutor Player target\\n  ) {\\n    target.give(item);\\n    sender.sendPlainMessage(\\"Success!\\");\\n  }\\n}\\n\`\`\`"},{"type":14,"divider":true,"spacing":1},{"type":10,"content":"This is all you need to create a command with an \`ItemStack\` argument and an optional \`Player\` argument, which defaults to the player who executed the command. There's a lot more to discover, so give it a try yourself! <:MahiruHeart:1520519275574460487>"},{"type":1,"components":[{"type":2,"style":5,"label":"Documentation","url":"https://commands.strokkur.net/","emoji":{"name":"🔥"}},{"type":2,"style":5,"label":"GitHub","url":"https://github.com/Strokkur424/StrokkCommands/","emoji":{"id":"927433909254369291","name":"github"}},{"type":2,"style":5,"label":"Join the Discord","url":"https://discord.strokkur.net/","emoji":{"id":"1553166325277523968","name":"discord"}}]}]}}`,
        },
      ],
    }),
  ],
