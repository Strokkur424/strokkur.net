...
You may add a `CommandSender` parameter anywhere on each method. This parameter describes the command sender of the
command. In Brigadier terms, this is the object you get from calling `ctx.getSource().getSender()`.
