...
public class GameModePreset {
  ...
  /*
   * A common method for handling both cases to reduce code repetition.
   */
...
There really is little to be said about this prototype which would not be self-explanatory. The `@Executes`-annotated
...
To use a prototype, you need to declare it as a field. This field should have its value initialized
