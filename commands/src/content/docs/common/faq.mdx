...
program that automatically runs each time you build your project, **generates** all required
...
## What are the design principles of StrokkCommands?
...
and keeps your plugin jar nice and light (the mentioned zero bytes of library code).
...
get right to coding your simple commands, without having to set up anything for it to work.

## Do you have a Discord server?
Yes! You can join the Discord server by visiting https://discord.strokkur.net/, which is my personal server
where you can talk about my libraries, get notified of updates, or just hang out and talk about plugin dev
