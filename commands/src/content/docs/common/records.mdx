...
This is perfectly fine and acceptable. The issues here start when you want to add more arguments. For example,
if you want to add another int argument, which limits the number of placed blocks per tick, the command would
