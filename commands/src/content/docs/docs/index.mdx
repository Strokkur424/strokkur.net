...
StrokkCommands is an **annotation-based command library**. You declare commands by using annotations (e.g. `@Command`)
on classes or methods. It was created for [Paper](https://github.com/PaperMC/Paper) and [Velocity](https://github.com/PaperMC/Velocity),
and also works fine on their forks, unless they mess with the command system.

StrokkCommands has every natively available argument type implemented. All you need to do is add whichever
